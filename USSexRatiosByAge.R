...
#I ACTUALLY AIMED FOR RESIDENT US JUST TO BE UNIFORM, BUT THE LINKED 1970s DATA INCLUDES OVERSEAS MILITARY (WHICH HAS THE BENEFIT OF INCLUDING US ARMED FORCES IN VIETNAM) 
##########
...
#GRAPH
plot(July1970SexRatio[16:60],type="l",,lwd=3,axes=FALSE,ylab="sex ratio",xlab="age",ylim=c(.8,1.1))
#lines(July1975SexRatio[16:60],col=2,lwd=3)
#lines(July1979SexRatio[16:60],col=3,lwd=3)
lines(July1980SexRatio$x[16:60],col=4,lwd=3)
#lines(July1985SexRatio$x[16:60],col=5,lwd=3)
#lines(July1989SexRatio$x[16:60],col=6,lwd=3)
lines(July1990SexRatio[16:60],col=7,lwd=3)
#lines(July1995SexRatio[16:60],col=8,lwd=3)
#lines(July1999SexRatio[16:60],col=9,lwd=3)
lines(July2000SexRatio[16:60],col=10,lwd=3)
#lines(July2005SexRatio[16:60],col=11,lwd=3)
#lines(July2009SexRatio[16:60],col=12,lwd=3)
lines(July2010SexRatio[16:60],col=13,lwd=3)
#lines(July2015SexRatio[16:60],col=14,lwd=3)
